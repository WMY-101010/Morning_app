...
@interface CalculationHelp : NSObject
...
+(CGFloat) angleFromPoint:(CGPoint)fromPoint toPoint:(CGPoint)toPoint;
 ...
 */
+(CGPoint)pointOnRadius:(CGFloat)radius atAngle:(CGFloat)angle;
