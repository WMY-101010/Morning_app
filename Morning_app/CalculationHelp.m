...
@implementation CalculationHelp
...
+(CGPoint)pointOnRadius:(CGFloat)radius
                atAngle:(CGFloat)angleFromNorth
{
    ...
    result.y = round((radius - 15) * sin(cartesianAngle));
    result.x = round((radius - 15) * cos(cartesianAngle));
